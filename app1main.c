/*
 * File:   app1main.c
 * Author: manbir briar, Azlfa Anwar
 *
 * Created on October 11, 2024, 3:58 PM
 */
...
int main(void) {
    ...
    while(1) { 
        ...
        Idle(); // device stays in idle mode
        IOcheck(); // button press device logic, triggered by CN_interrupt
